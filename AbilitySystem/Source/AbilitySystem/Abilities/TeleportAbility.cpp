...
void UTeleportAbility::OnActivation(APlayerCharacter* _Player)
{
...
void UTeleportAbility::Update(float _DeltaSeconds)
{
...
void UTeleportAbility::OnDeactivation()
{
...
void UTeleportAbility::UpdateTeleportVariables(APlayerCharacter* _PlayerPtr)
{
	bCanMantle = false;
	bShouldCrouch = false;
...
bool UTeleportAbility::InitialTrace(FVector& _TeleportLocation, FHitResult& _TraceHit, APlayerCharacter* _PlayerPtr) const
{
	FVector TraceStart;
...
void UTeleportAbility::MantleTrace(const FHitResult _InitialTraceHit, FVector& _TeleportLocation, APlayerCharacter* _PlayerPtr)
{
...
bool UTeleportAbility::CheckHeadRoom(FVector& _TeleportLocation, APlayerCharacter* _PlayerPtr)
{
