 ...
 */
UCLASS()
class ABILITYSYSTEM_API UAb_Blink : public UBaseAbility
{
	GENERATED_BODY()
...
private:
	UPROPERTY(EditAnywhere, Category = "Blink|Cursors")
	...
	// (cm)
	UPROPERTY(EditAnywhere, Category = "Blink", meta=(ClampMin="100.0"))
	float TeleportRange = 1000.f;

	// How far away from a top edge (cm) to teleport on top of it
	UPROPERTY(EditAnywhere, Category = "Blink", meta=(ClampMin="10.0"))
	...
	UPROPERTY(EditAnywhere, Category = "Blink", meta = (ClampMin = "0.0", ClampMax = "1.0"))
	float WallDotTolerance = 0.6f;

	// The radius (cm) of the initial sphere trace
	UPROPERTY(EditAnywhere, Category = "Blink", meta = (ClampMin = "0.1"))
...
#pragma region Debugging
	...
	UPROPERTY(EditAnywhere, Category = "Blink|Debugging")
	...
	UPROPERTY(EditAnywhere, Category = "Blink|Debugging", meta = (EditCondition = "bDrawHeadRoom", EditConditionHides))
	...
	UPROPERTY(EditAnywhere, Category = "Blink|Debugging", meta = (EditCondition = "bDrawMantle", EditConditionHides))
